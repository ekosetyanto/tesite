...
function getConnection() {
	...
	global $db_tesite_db_Url, $db_tesite_db_User, $db_tesite_db_Pass, $db_tesite_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_tesite_db_Url.";dbname=".$db_tesite_db_DbName, $db_tesite_db_User, $db_tesite_db_Pass);
